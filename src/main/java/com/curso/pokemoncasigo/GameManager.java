...
import com.curso.pokemoncasigo.Pokemon.Type;
...
public class GameManager {
    ...
    */
    ...
    /*
        Get a string with the name and level of all the player's Pokemon
    */
    public String getPlayerPokemonString(){
        String text = "";
        int count = 0;
        for(Pokemon p : playerPokemon){
            text += count + "-" + p.getName() + " level(" + p.getLevel() + ") \n";
            count++;
        }
        return text;
    }
    ...
    /*
        Get a string with all the data of the player's Pokemon
    */
    public String getPlayerPokemonDataString(){
        String text = "";
        int count = 0;
        for(Pokemon p : playerPokemon){
            text += count + " -> " + p.getName() + " Level(" + p.getLevel() + ")" + " Strength(" + p.getStrength() + ")" + " Type(" + p.getType()  +") \n";
            count++;
        }
        return text;
    }
